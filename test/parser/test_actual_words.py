...
"""
This suite checks that specific actual words are correctly imported
from the given CSV dictionary, and are parsed accurately.

These tests use the actual FST rules and the actual dict.csv file.
"""
...
class TestLexiconImport(TestFSTOutput):
    ...
    @classmethod
    def setUpClass(cls):
        super().setUpClass(FULL_SGX, None)
